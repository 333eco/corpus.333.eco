...
const envelope = (d) => ({
    ...
    provenance: {
        ...d.provenance,
        verify: {
            sha256: "shasum -a 256 <the source file>   # compare to provenance.sha256, computed over the FULL source file including its metadata block",
...
const callTool = (corpus, name, args) => {
    ...
    if (name === "get_document") {
        ...
        return asText({ ...envelope(d), genre: d.genre, repo: d.repo, path: d.path, metadata_convention: d.metadata_convention, text: d.text });
    }
